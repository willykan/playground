export const sentenceList = [
  ...
  "As time wore on, simple dog commands turned into full sentences explaining why the dog couldn't do something.",
...
/**
 * Generates an array of random sentences.
 *
 * @param {number} length - The length of the output array.
 * @returns {Array<string>} - An array of randomly selected sentences.
 * @throws Will throw an error if the length is not a positive integer.
 */
export function generateSentence(length = 1) {
